	...
	private void initComponent() {
		...
		this.add.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				CustomerGiftInfoDialog dialog = new CustomerGiftInfoDialog(
						frame, tablepane, true);
			...
			public void actionPerformed(ActionEvent e) {
				if (tablepane.isSelected()) {
					int result = MyOptionPane.showConfirmDialog(frame,
							"确认停用改促销策略？", "确认提示", MyOptionPane.YES_NO_OPTION,
		...
		this.tablepane = new CustomerTablePane(new TableConfig(
				cfg.getTablepane()));
		this.add(this.add);
