...
public class PurchaseBLService_Driver{
	...
	public void drive(PurchaseBLService sbs) throws RemoteException{
	    ...
	    if(result==ResultMessage.SUCCESS)
	    	System.out.println("添加进货单成功！\n");
	    else
	    	System.out.println("添加进货单失败！\n");

	    ArrayList<PurchaseVO> list=sbs.show();
	    System.out.println("进货单查看结果：");
	    System.out.println("客户编号:"+list.get(0).customerId+"；客户姓名："+list.get(0).id+
	                       "；操作员："+list.get(0).id+"；仓库："+
	    		           list.get(0).storage+"\n"+"出货商品清单：\n"+
	    ...
	    System.out.println("按商品名称查找进货单的结果：");
	    System.out.println("客户编号:"+list.get(0).customerId+"；客户姓名："+list.get(0).id+
                "；操作员："+list.get(0).id+"；仓库："+
		           list.get(0).storage+"\n"+"出货商品清单：\n"+
                "商品编号："+list.get(0).saleList.get(0).id+"；商品名称："+
	    ...
	    System.out.println("按客户查找进货单的结果：");
	    System.out.println("客户编号:"+list.get(0).customerId+"；客户姓名："+list.get(0).id+
                "；操作员："+list.get(0).id+"；仓库："+
		           list.get(0).storage+"\n"+"出货商品清单：\n"+
                "商品编号："+list.get(0).saleList.get(0).id+"；商品名称："+
	    ...
	    System.out.println("按业务员查找进货单的结果：");
	    System.out.println("客户编号:"+list.get(0).customerId+"；客户姓名："+list.get(0).id+
                "；操作员："+list.get(0).id+"；仓库："+
		           list.get(0).storage+"\n"+"出货商品清单：\n"+
                "商品编号："+list.get(0).saleList.get(0).id+"；商品名称："+
	    ...
	    System.out.println("按仓库查找进货单的结果：");
	    System.out.println("客户编号:"+list.get(0).customerId+"；客户姓名："+list.get(0).id+
                "；操作员："+list.get(0).id+"；仓库："+
		           list.get(0).storage+"\n"+"出货商品清单：\n"+
                "商品编号："+list.get(0).saleList.get(0).id+"；商品名称："+
